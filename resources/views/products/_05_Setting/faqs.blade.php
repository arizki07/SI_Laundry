        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header bg-blue-lt">
                    <h5 class="modal-title text-blue">Tambah Faqs</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul" class="form-control" required
                                placeholder="Masukkan judul faqs">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Deskripsi</label>
                            <textarea class="form-control" name="deskripsi" rows="6" placeholder="Isi deskripsi faqs"></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background: blue;">
                        <h5 class="modal-title text-white">Edit Faqs</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{ route('faqs.update', $item->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label">Judul</label>
                                <input type="text" name="judul" class="form-control" required
                                    placeholder="Masukkan judul faqs" value="{{ $item->judul }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Deskripsi</label>
                                <textarea class="form-control" name="deskripsi" rows="6" placeholder="Isi deskripsi faqs">{{ $item->deskripsi }}</textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn me-auto" data-bs-dismiss="modal">Tutup</button>
...
<script type="text/javascript">
    ...
    $(function() {
        tableFaqs = $('.yajra').DataTable({
            ...
            "buttons": [{
                ...
                },
                {
                    ...
                    text: '<i class="fa fa-add"></i> Add Faqs',
                    action: function(e, dt, node, config) {
        ...
        modal.addEventListener('show.bs.modal', function(event) {
            ...
            deleteForm.action = `/faqs/destroy/${recordId}`;
        });
    });
</script>
@endsection