                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md">
                                                    ...
                                                    <small
                                                        class="@error('head_first') text-danger @else text-indigo @enderror">
                                                        @error('head_first')
                                                            * {{ $message }}
                                                        @else
                                                ...
                                                <div class="col-md">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="head_two"
                                                        value="{{ old('head_two', $kontak->head_two ?? '') }}"
                                    ...
                                    <form action="{{ route('karyawan.update') }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-auto mb-4">
                                                    <h3 class="card-title mt-4">Settings</h3>
                                                    <p class="card-subtitle">Perbaharui password akun ini?</p>
                                                    <div>
                                                        {{-- <label for="avatarInput"
                                                            class="btn me-2 @error('alamat') border-danger @enderror""
                                                            style="font-size: 12px;">Ubah Logo
                            ...
                            <div class="input-group input-group-flat">
                                ...
                                <span class="input-group-text">
                                    <a href="#" class="input-group-link"
                                        onclick="togglePassword('password_saat_ini')">
