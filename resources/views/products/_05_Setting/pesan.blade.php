...
@section('modals')
    @foreach ($pesan as $item)
        <div class="modal modal-blur fade" id="modal-lihat{{ $item->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" class="form-control" required
                                    placeholder="Masukkan nama " value="{{ $item->email }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Subject</label>
                                <input type="text" name="subject" class="form-control" required
                                    placeholder="Masukkan nama " value="{{ $item->subject }}">
                            </div>
                            <div class="mb-3">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            modal.addEventListener('show.bs.modal', function(event) {
                ...
                deleteForm.action = `/pesan/destroy/${recordId}`;
            });
        });
    </script>
@endsection
