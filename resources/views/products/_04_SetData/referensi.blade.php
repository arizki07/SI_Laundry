...
@section('content')
    ...
    <div class="page">
                        ...
                        <div class="col-auto ms-auto d-print-none">
                            <ol class="breadcrumb" aria-label="breadcrumbs">
                                <li class="breadcrumb-item"><a href="{{ url('dashboard') }}"><i class="fa fa-home"></i>
                                        Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="#"><i
                                            class="fa-solid fa-bell"></i> {{ $judul }}</a></li>
                            </ol>
                        </div>
                            ...
                            <div class="card card-xl border-primary shadow rounded">
                                ...
                                <div class="table-responsive">
                                    <table style="width:100%; font-family: 'Trebuchet MS', Helvetica, sans-serif;"
                                        class="table table-sm table-bordered table-striped table-vcenter card-table table-hover text-nowrap datatable datatable-status">
                                    </table>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal modal-blur fade" id="modal-edit{{ $item->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('referensi.update', $item->id) }}" method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="modal-body">
                                        <div class="mb-3">
        ...
        <script type="text/javascript">
            ...
            $(function() {
                tableCategories = $('.datatable-status').DataTable({
                    ...
                    "buttons": [{
                        ...
                        },
                        {
                            ...
                            text: '<i class="fa fa-add"></i> Add Referensi',
                            action: function(e, dt, node, config) {
                ...
                modal.addEventListener('show.bs.modal', function(event) {
                    ...
                    deleteForm.action = `/referensi/destroy/${recordId}`;
                });
            });
        </script>
    </div>
