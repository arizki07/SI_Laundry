...
@section('content')
    <div class="page">
                            ...
                            <div class="card card-xl border-primary shadow rounded">
                                ...
                                <div class="table-responsive">
                                    <table style="width:100%; font-family: 'Trebuchet MS', Helvetica, sans-serif;"
                                        class="table table-sm table-bordered table-striped table-vcenter card-table table-hover text-nowrap datatable datatable-categories">
                                    </table>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background: blue;">
                            <h5 class="modal-title text-white">Tambah Category</h5>
                            ...
                            <form action="{{ route('categories.update', $item->id) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Nama</label>
                                        <input type="text" name="nama" class="form-control" required
                                            placeholder="Masukkan nama produk" value="{{ $item->nama }}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Deskripsi</label>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                tableCategories = $('.datatable-categories').DataTable({
                    ...
                    "buttons": [{
                        ...
                        },
                        {
                            ...
                            text: '<i class="fa fa-add"></i> Add Category',
                            action: function(e, dt, node, config) {
                ...
                modal.addEventListener('show.bs.modal', function(event) {
                    ...
                    deleteForm.action = `/categories/destroy/${recordId}`;
                });
            });
        </script>
    </div>
